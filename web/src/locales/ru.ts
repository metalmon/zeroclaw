export const ru: Record<string, string> = {
  ...
  'roles.delete_profile_message': 'Роль «{value}» будет удалена. Субъекты, которые останутся привязанными к ней, будут ссылаться на роль, не дающую прав доступа, — до тех пор, пока не будут переподключены.',
  ...
  'roles.delete_profile_affected_other': '{n} субъектов теперь ссылаются на этот профиль и должны быть переподключены:',
