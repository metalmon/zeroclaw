export const ru: Record<string, string> = {
  ...
  'unsaved_banner.unsaved_changes_count_one': 'несохранённое изменение',
  'unsaved_banner.unsaved_changes_count_few': 'несохранённых изменения',
  'unsaved_banner.unsaved_changes_count_many': 'несохранённых изменений',
  'fieldform.entries_count_one': 'запись',
  'fieldform.entries_count_few': 'записи',
  'fieldform.entries_count_many': 'записей',
  'roles.delete_profile_affected_one': 'субъект теперь ссылается на этот профиль и должен быть переподключён к другому:',
  'roles.delete_profile_affected_few': 'субъекта теперь ссылаются на этот профиль и должны быть переподключены к другому:',
  'roles.delete_profile_affected_many': 'субъектов теперь ссылаются на этот профиль и должны быть переподключены к другому:',
  'roles.token_count_one': 'токен',
  'roles.token_count_few': 'токена',
  'roles.token_count_many': 'токенов',
  'roles.device_count_one': 'устройство',
  'roles.device_count_few': 'устройства',
  'roles.device_count_many': 'устройств',
  'skills.skipped_count_one': 'навык пропущен (не прошёл проверку безопасности)',
  'skills.skipped_count_few': 'навыка пропущены (не прошли проверку безопасности)',
  'skills.skipped_count_many': 'навыков пропущены (не прошли проверку безопасности)',
  'sops.steps_count_one': 'шаг',
  'sops.steps_count_few': 'шага',
  'sops.steps_count_many': 'шагов',
  'logs.events_count_one': 'событие',
  'logs.events_count_few': 'события',
  'logs.events_count_many': 'событий',
