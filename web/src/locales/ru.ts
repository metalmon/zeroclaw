export const ru: Record<string, string> = {
  ...
  'config.alias_help_no_rename': 'Псевдонимы нельзя переименовать в v0.8.0',
  'config.alias_help_rename_advice': '— выбирайте имя с расчетом на будущее или удалите и создайте запись заново.',
  'config.alias_help_rules': 'Правила: строчные буквы, цифры, одиночные символы подчеркивания; от 1 до 63 символов; без начальных, конечных и двойных подчеркиваний, точек, дефисов и пробелов.',
  ...
  'config.delete_owned_state': 'Удаление агента также удалит его память, задания расписания и сессии.',
  ...
  'config.nothing_configured_pre': 'В',
